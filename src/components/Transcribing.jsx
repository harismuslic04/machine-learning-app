...
export default function Transcribing(props) {
  ...
  return (
    <div className="flex items-center flex-col flex-1 justify-center text-center gap-10 md:gp-14 py-24 p-4">
      <div className="flex flex-col gap-2 sm:gap-4">
        ...
        <p>
          {!downloading ? "warming up cylinders" : "core cylindres engaded"}
        </p>
      </div>
